...
/* import { xScaleSVG, timeScale } from "./scales.js"; */

const { /* w, h, */ ageMin, ageMax, margin, fontFamily, fontSize } = settings;

export function createXAxis(svg, xScaleSVG, h) {
...
export function createYAxis(svg, timeScale, w) {
